...
# Armo la matriz de inversores, con cantidad en común
...
rm(matriz_a_medias, matriz_inversores)
...
# Creamos el objeto network, a partir de la 
...
edgelist_inversores <- network(edgelist_inversores,
                               matrix.type = "edgelist")

summary(edgelist_inversores)

```

```{r}

gplot(edgelist_inversores)
